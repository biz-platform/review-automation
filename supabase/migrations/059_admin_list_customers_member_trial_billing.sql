-- admin_list_customers: 일반 회원 무료(2026-05-31까지 전체 프로모 + 5/1 이후 가입 1개월) 반영 → billing_state에 trial 추가
-- KST 경계: 2026-05-01 00:00 = 2026-04-30 15:00 UTC, 2026-06-01 00:00 = 2026-05-31 15:00 UTC
    ...
    SELECT
      ...
      CASE
        ...
        WHEN u.role = 'member'
          ...
          AND (
            now() < GREATEST(
              '2026-05-31 15:00:00+00'::timestamptz,
              CASE
                WHEN u.created_at >= '2026-04-30 15:00:00+00'::timestamptz
                THEN u.created_at + interval '1 month'
                ELSE '-infinity'::timestamptz
              END
            )
          ) THEN 'trial'
        WHEN u.role = 'member' THEN 'unpaid'
